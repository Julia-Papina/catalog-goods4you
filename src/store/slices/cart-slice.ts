...
export const fetchCart = createAsyncThunk<ProductType[], void, { state: RootState }>(
  'cart/fetchCart',
  async (_, { getState, rejectWithValue }) => {
      ...
      const updatedProducts = await Promise.all(products.map(async (product: ProductType) => {
...
export const updateCart = createAsyncThunk<ProductType[], { userId: number, products: ProductType[] }, { state: RootState }>(
  'cart/updateCart',
...
export const checkProductInCart = createAsyncThunk<ProductType, { productId: number }, { state: RootState }>(
